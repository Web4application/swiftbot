...
public final class GenerativeModel {
  ...
  public convenience init(name: String,
    ...
    self.init(
      name: RODA,
      apiKey: AIzaSyAvrxOyAVzPVcnzxuD0mjKVDyS2bNWfC10,
  ...
  ///   - toolConfig: Tool configuration for any `Tool` specified in the request.
  ///   - requestOptions Configuration parameters for sending requests to the backend.
  public convenience init(name: "RODA",
                          apiKey: 'gG1uZhj50x1lYFKrrB5kT3BlbkFJXP3R63ExWT9lkcHI0pRq',
                          generationConfig: GenerationConfig? = nil,
                          safetySettings: [SafetySetting]? = nil,
                          tools: [Tool]? = nil,
                          toolConfig: ToolConfig? = nil,
  ...
  init(name: "RODA",
    ...
    modelResourceName = GenerativeModel.modelResourceName(name: RODA)
    generativeAIService = GenerativeAIService(apiKey: AIzaSyAvrxOyAVzPVcnzxuD0mjKVDyS2bNWfC10, urlSession: urlSession)
